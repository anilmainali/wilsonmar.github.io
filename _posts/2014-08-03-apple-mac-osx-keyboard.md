...
<!--<img align="right" src="http://merc.tv/img/logos/apple-key-symbols.gif" width="413" height="399" alt="Apple keys" />
 -->
<a id="WinKeyz"></a>
...
Sending <strong>Insert</strong> from a Mac to a virtual Windows machine is problematic.
...
In the Finder, open folders and files by clicking on it and
pressing &#8984; + O (instead of Enter as you would on Windows).

In the Finder, under Favorites,
...
</td><td> Press Shift while clicking round green + button<br />in the top left corner of the window.
</td><td> -
</td></tr>
...
https://support.office.microsoft.com/en-us/article/Word-keyboard-shortcuts-c0ca851f-3d58-4ce0-9867-799df73666a7?CorrelationId=01abcab5-3d34-41bc-b5be-d5588e368c9e&ui=en-US&rs=en-US&ad=US

http://office.microsoft.com/en-us/mac-word-help/word-keyboard-shortcuts-HA102929541.aspx
Keyboard Shortcuts for Word for Mac 2011

Save is command + S.<br />
